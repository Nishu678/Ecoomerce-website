import { Mail, Phone, MapPin, Clock, Send, MessageSquare, Users, Shield, HelpCircle, Globe, ShoppingBag, Package, Truck, CreditCard } from 'lucide-react'
            ...
            <div className="container mx-auto px-4 py-15">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                        We're here to help with your orders, returns, product questions, and any shopping assistance you need. Our team is ready to ensure you have the best shopping experience.
                    </p>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-lg text-muted-foreground">
                                We're committed to providing exceptional support to ensure you have the best shopping experience.
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                                ...
                                <div>
                                    <h3 className="font-semibold text-foreground mb-2">Fast & Free Shipping</h3>
                                    <p className="text-sm text-muted-foreground">
                                        Enjoy free shipping on orders over $50. Most orders ship within 24 hours and arrive in 2-3 business days.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Not happy with your purchase? Return it within 30 days for a full refund or exchange. We provide prepaid return labels.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Shop with confidence. We use bank-level encryption to protect your payment information and personal data.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground mb-4">
                                            Check our FAQ for instant answers about shipping, returns, sizing, and more.
                                        </p>
            ...
            <div className="bg-primary/5 py-14">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Join millions of satisfied customers who shop with confidence and receive exceptional support.
                    </p>
